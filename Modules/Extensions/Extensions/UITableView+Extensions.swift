...
extension UITableView {
    ...
    public func dequeueReusableCell<T: UITableViewCell>(
        ...
        guard
            ...
            fatalError(DequeueReusableError.cellWithIdentifier(cellType.reuseID).description)
        }
        return cell
    }
    ...
    public func dequeueReusableHeaderFooter<T: UITableViewHeaderFooterView>(ofType viewType: T.Type) -> T {
        guard
            ...
            fatalError(DequeueReusableError.viewWithIdentifier(viewType.reuseID).description)
        }
        return view
    }
}
